...
static std::map<std::string, std::string> TextJPMap =
{
	...
	{"[Use 4MB Memory(Unsafe)]","[4Mバイトのメモリを使用（非推奨）]"},
	{"Memory size will change after you reset MSX.","メモリサイズは再起動後に有効になります。"},
	{"[Cheat]","[チート]"},
	{"[Quit fMSX]","[fMSXを終了する]"},
	{"Config","[設定]"},
	...
	{ "[Select a HDD image]","[ハードディスクイメージを選択してください]"},
	...
	{ "Use X or Y key to change transparent.","X、Yキーを押すと参照画像の透明度を変更します。"},
