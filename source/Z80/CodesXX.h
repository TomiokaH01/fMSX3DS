...
/*************************************************************/
#ifdef TURBO_R
case JR_NZ:   if (R->AF.B.l & Z_FLAG) R->PC.W++; else { R->ICount -= (R->User & 0x01) ? 1 : 5; M_JR; } break;
case JR_NC:   if (R->AF.B.l & C_FLAG) R->PC.W++; else { R->ICount -= (R->User & 0x01) ? 1 : 5; M_JR; } break;
case JR_Z:    if (R->AF.B.l & Z_FLAG) { R->ICount -= (R->User & 0x01) ? 1 : 5; M_JR; } else R->PC.W++; break;
case JR_C:    if (R->AF.B.l & C_FLAG) { R->ICount -= (R->User & 0x01) ? 1 : 5; M_JR; } else R->PC.W++; break;
...
case RET_NZ:  if (!(R->AF.B.l & Z_FLAG)) { R->ICount -= (R->User & 0x01) ? 4 : 6; M_RET; } break;
case RET_NC:  if (!(R->AF.B.l & C_FLAG)) { R->ICount -= (R->User & 0x01) ? 4 : 6; M_RET; } break;
case RET_PO:  if (!(R->AF.B.l & P_FLAG)) { R->ICount -= (R->User & 0x01) ? 4 : 6; M_RET; } break;
case RET_P:   if (!(R->AF.B.l & S_FLAG)) { R->ICount -= (R->User & 0x01) ? 4 : 6; M_RET; } break;
case RET_Z:   if (R->AF.B.l & Z_FLAG) { R->ICount -= (R->User & 0x01) ? 4 : 6; M_RET; } break;
case RET_C:   if (R->AF.B.l & C_FLAG) { R->ICount -= (R->User & 0x01) ? 4 : 6; M_RET; } break;
case RET_PE:  if (R->AF.B.l & P_FLAG) { R->ICount -= (R->User & 0x01) ? 4 : 6; M_RET; } break;
case RET_M:   if (R->AF.B.l & S_FLAG) { R->ICount -= (R->User & 0x01) ? 4 : 6; M_RET; } break;

case CALL_NZ: if (R->AF.B.l & Z_FLAG) R->PC.W += 2; else { R->ICount -= (R->User & 0x01) ? 5 : 7; M_CALL; } break;
case CALL_NC: if (R->AF.B.l & C_FLAG) R->PC.W += 2; else { R->ICount -= (R->User & 0x01) ? 5 : 7; M_CALL; } break;
case CALL_PO: if (R->AF.B.l & P_FLAG) R->PC.W += 2; else { R->ICount -= (R->User & 0x01) ? 5 : 7; M_CALL; } break;
case CALL_P:  if (R->AF.B.l & S_FLAG) R->PC.W += 2; else { R->ICount -= (R->User & 0x01) ? 5 : 7; M_CALL; } break;
case CALL_Z:  if (R->AF.B.l & Z_FLAG) { R->ICount -= (R->User & 0x01) ? 5 : 7; M_CALL; } else R->PC.W += 2; break;
case CALL_C:  if (R->AF.B.l & C_FLAG) { R->ICount -= (R->User & 0x01) ? 5 : 7; M_CALL; } else R->PC.W += 2; break;
case CALL_PE: if (R->AF.B.l & P_FLAG) { R->ICount -= (R->User & 0x01) ? 5 : 7; M_CALL; } else R->PC.W += 2; break;
case CALL_M:  if (R->AF.B.l & S_FLAG) { R->ICount -= (R->User & 0x01) ? 5 : 7; M_CALL; } else R->PC.W += 2; break;
#else
...
#ifdef TURBO_R
case DJNZ: if (--R->BC.B.h) { R->ICount -= (R->User & 0x01) ? 1 : 5; M_JR; }else R->PC.W++; break;
#else
