...
Homebrew Launcher:「fMSX3DS.3dsx」をSDカードの「/3DS」フォルダにコピーしてください。

CIAバージョン、Homebrew LauncherバージョンのどちらでもSDカードの「/3DS」フォルダに「dsp.firm」ファイルが無いと音が鳴りません。
...
そうでないなら、以下のBIOSファイルをSDカードのルートまたは「/FMSX3DS」フォルダにコピーします。
MSX.ROM
MSX2.ROM
MSX2EXT.ROM
MSX2P.ROM 
...
このC-BIOSでほとんどのROMカートリッジのゲームが動作しますが、ディスクはサポートしていませんし、
...
<7.特殊な周辺機器>
fMSX3DSはMSXのエミュレーターで初めて+PCMとボイスボックスを再現します。
...
<8.Q&A>
Q.fMSX3DSが動作しません！
A.「/FMSX3DS」フォルダの中の「fMSX3DS.cfg」を消してみてください。
